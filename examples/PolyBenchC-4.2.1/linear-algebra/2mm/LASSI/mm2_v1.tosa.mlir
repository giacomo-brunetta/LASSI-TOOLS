module attributes {torch.debug_module_name = "TwoMMV1"} {
  func.func @forward(%arg0: tensor<1xf32>, %arg1: tensor<1xf32>, %arg2: tensor<800x1100xf32>, %arg3: tensor<1100x900xf32>, %arg4: tensor<900x1200xf32>, %arg5: tensor<800x1200xf32>) -> tensor<800x1200xf32> {
    ...
    %8 = tosa.reshape %5 {new_shape = array<i64: 1, 800, 900>} : (tensor<800x900xf32>) -> tensor<1x800x900xf32>
    %9 = tosa.reshape %arg4 {new_shape = array<i64: 1, 900, 1200>} : (tensor<900x1200xf32>) -> tensor<1x900x1200xf32>
    %10 = tosa.matmul %8, %9 : (tensor<1x800x900xf32>, tensor<1x900x1200xf32>) -> tensor<1x800x1200xf32>
    %11 = tosa.reshape %10 {new_shape = array<i64: 800, 1200>} : (tensor<1x800x1200xf32>) -> tensor<800x1200xf32>
    %12 = tosa.add %7, %11 : (tensor<800x1200xf32>, tensor<800x1200xf32>) -> tensor<800x1200xf32>
