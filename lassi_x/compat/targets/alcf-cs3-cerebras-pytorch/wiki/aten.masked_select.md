...
|---|---|---|---|
| `fp16` / `canonical` | `compile_rejected` | self: shape=(2, 3) dtype=float16; mask: shape=(2, 3) dtype=bool | RuntimeError: Unimplemented Error:  	/n0/jenkins/node2_large/workspace/pytorch/build-ml_frameworks/torch-mlir/setup_build/cmake_build/tools/torch-mlir/projects/ltc/csrc/base_lazy_backend/generated/shape_inference.cpp:95    std::vector<torch::lazy::Shape> torch::lazy::compute_shape_masked_select(const at::Tensor&, const at::Tensor&) |
