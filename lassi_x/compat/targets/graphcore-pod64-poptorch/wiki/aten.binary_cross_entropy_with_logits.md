...
| `fp32` / `canonical` | `compiled` | self: shape=(2, 3) dtype=float32; target: shape=(2, 3) dtype=float32; weight: shape=(2, 3) dtype=float32; pos_weight: shape=(2, 3) dtype=float32; reduction: 1 | — |
