...
from lassi_x.compat.io import atomic_json, load_json, stable_hash
...
def publish_snapshot(
    ...
    target_path = output_root / "targets" / target_id
    snapshot_path = target_path / "snapshot.json"
    wiki_path = target_path / "wiki"
