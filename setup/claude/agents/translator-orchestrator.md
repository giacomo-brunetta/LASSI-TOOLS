...
3. **Phase 2: Translation Implementation**
   ...
   - Delegate this task to the translator agent with the Task tool.
...
6. **Phase 5: Model Generation**
   ...
   - Delegate this task to the model-generator agent with the Task tool.
...
11. Use the Debugger Agent only as an absolute last resort:
...
12. Prefer file handoffs over prose handoffs:
