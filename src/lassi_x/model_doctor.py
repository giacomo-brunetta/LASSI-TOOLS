...
def _internal_id_hint(model: str) -> str:
    ...
    return (
        ...
        "set it as endpoint_model in experiments/paper/benchmarks.yaml."
    )
    ...
    if response.is_success:
        ...
        return ProbeReport(
            ...
            hint=(
                ...
                f"with a model that never ran. Set endpoint_model in "
                f"experiments/paper/benchmarks.yaml to the served identifier, or "
